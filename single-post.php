...
<!-- Статья -->
<article class="v2-single-post" itemscope itemtype="https://schema.org/BlogPosting">
    <?php 
    ...
    <div class="v2-container">
        <div class="v2-single-post__layout">
            <!-- Контент статьи -->
            <div class="v2-col-12 v2-col-lg-8 v2-single-post__content">
                <header class="v2-single-post__header">
                ...
                <?php if (!is_featured_article()) : ?>
                    <!-- Дисклеймер -->
                    <div class="v2-single-post__disclaimer">
                    ...
                    <!-- Бирюзовая полоска -->
                    <div class="v2-single-post__brand-stripe"></div>
                <?php endif; ?>
                
                <div class="v2-single-post__text" itemprop="articleBody">
                    <?php the_content(); ?>
                </div>
                ...
                if (!empty($related_posts) && is_array($related_posts)) {
                    ...
                    if (!empty($related_posts)) {
                        ...
                        if ($related_query->have_posts()) : ?>
                            <section class="v2-single-post__related">
                ...
                <footer class="v2-single-post__footer">
                    <a href="<?php echo home_url('/blog/'); ?>" class="v2-single-post__back-link">← Вернуться к блогу</a>
                </footer>
            </div>
            
            <!-- Форма обратной связи -->
            <aside class="v2-sidebar-form">
