...
<section class="plus-grid-section">
    <div class="plus-grid-layout">
        <div class="header">
            <h2>Премиум-лечение<br>по адекватной цене</h2>
        </div>
        ...
        <div class="header-plus">
            ...
            <h3>Мы используем только проверенные системы имплантов и гарантируем результат.</h3>
        </div>
        ...
        <div class="plus-card plus-5">
            ...
            <div class="plus-5-content">
                ...
                <p>Без боли, с временной коронкой сразу. Благодаря нашей цифровой лаборатории вы уходите домой уже с зубом.</p>
                <button type="button" class="btn-1" onclick="openPopup()">Хочу зубы за один день</button>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="grid-system">
        ...
        <div class="trust-grid grid-12">
            ...
            <div class="guarantees-right">
                ...
                <div>
                    <h3>Почему гарантия на работу врача — 1 год?</h3>
                    <p>Год — это объективный срок, в течение которого можно оценить результат лечения.</p>
                    <p>Далее многое зависит от самого пациента: здоровье, гигиена, хронические болезни и соблюдение рекомендаций.</p>
                    <p>Бессрочная гарантия — это миф. Мы даём честную и обоснованную гарантию. И даже когда срок заканчивается, мы всегда остаёмся рядом, открыты к вашим вопросам и готовы помочь в любой ситуации.</p>
                </div>
                
                <!-- 4 ряд - 3 пункта по горизонтали -->
                <div>
                    <h4>Дополнительно</h4>
                </div>
                <div class="additional-items">
                    <div class="additional-item">
                        <p>Только сертифицированные импланты.</p>
                    </div>
                    <div class="additional-item">
                        <p>Честная цена с первой консультации.</p>
                    </div>
                    <div class="additional-item">
                        <p>Налоговый вычет</p>
                    </div>
...
<section class="implants-section">
    ...
    <!-- Блок дополнительных бонусов -->
    <div class="implants-bonus grid-system">
        <div class="bonuses-left grid-4">
            <h3>Дополнительные бонусы для всех пакетов</h3>
        </div>
        <div class="bonuses-right grid-8">
            <div class="bonus-cards">
                ...
                <div class="bonus-card">
                    <h4>Полное сопровождение до результата</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid-system">
        <div class="technologies-grid grid-12">
            <div class="technologies-header">
                <h2>Самые современные технологии для точного и быстрого результата на Европейском уровне</h2>
            </div>
