        ...
        <div class="v2-row">
            <div class="v2-col-sm-12 v2-col-lg-6 v2-hero__left">
                ...
                <div class="v2-hero__description">
                    <div class="v2-hero__benefits-row">
                ...
                <div class="v2-hero__actions">
                    ...
                    <button type="button" class="v2-hero__whatsapp-btn" onclick="window.open('https://wa.me/79084952424', '_blank')" aria-label="Связаться через WhatsApp">
                        <svg class="v2-hero__whatsapp-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                <div class="v2-hero__stats">
                    <div class="v2-hero__stats-list" itemscope itemtype="https://schema.org/ItemList">
                        <div class="v2-hero__stat v2-hero__stat--first" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            ...
                            <span class="v2-hero__stat-number">25 000</span>
                        ...
                        <div class="v2-hero__stat v2-hero__stat--second" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            ...
                            <span class="v2-hero__stat-number">99,8%</span>
                    ...
                    <div class="v2-hero__testimonial" itemscope itemtype="https://schema.org/Review">
                        ...
                        <a href="<?php echo home_url('/istoriya-moei-ulybki'); ?>" class="v2-hero__testimonial-link" aria-label="Читать отзыв Лилии Питерской">Читать далее</a>
            </div>
                </div>
            </div>
        </div>
    ...
    <div class="v2-container">
        ...
        <div class="v2-row">
            <div class="v2-col-sm-12 v2-col-lg-8 v2-plus__left">
                <div class="v2-plus__cards-grid">
                    <div class="v2-plus__card">
                    ...
                    <div class="v2-plus__card v2-plus__card--bg">
                        <video 
        ...
        <div class="v2-row">
            <div class="v2-col-sm-12 v2-col-lg-8">
                <div class="v2-technologies__grid">
                    ...
                    <article class="v2-technologies__card" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                        <meta itemprop="position" content="2">
                        <div class="v2-technologies__card-icon">
                        ...
                        <div class="v2-technologies__card-text">
        ...
        <div class="v2-row">
            ...
            <div class="v2-col-sm-12 v2-col-lg-4">
                <article class="v2-china-risks__card v2-china-risks__card--featured" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <meta itemprop="position" content="5">
                    <div class="v2-china-risks__faces-container">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/circle-face-01.jpg" alt="Довольный пациент" class="v2-china-risks__face v2-china-risks__face--1" loading="lazy">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/circle-face-02.jpg" alt="Довольная пациентка" class="v2-china-risks__face v2-china-risks__face--2" loading="lazy">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/circle-face-07.jpg" alt="Довольный пациент" class="v2-china-risks__face v2-china-risks__face--3" loading="lazy">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/circle-face-08.jpg" alt="Довольная пациентка" class="v2-china-risks__face v2-china-risks__face--4" loading="lazy">
                    </div>
