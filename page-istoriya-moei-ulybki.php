    ...
    <div class="grid-system">
        <div class="story-left grid-6">
            <div class="story-image">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/circle-face-08.jpg" alt="Лилия Питерская">
            </div>
        </div>
        
        <div class="story-right grid-6">
            <div class="story-text">
                <h2>Лилия Питерская</h2>
                <p>Делюсь историей своей новой улыбки</p>
                
                <div class="story-description">
                    <p>Здесь будет история Лилии о том, как она восстановила свою улыбку в нашей клинике. Подробный рассказ о процессе лечения, ощущениях и результатах.</p>
                    
                    <p>Каждый пациент имеет свою уникальную историю, и мы гордимся тем, что можем помочь людям обрести уверенность в своей улыбке.</p>
                </div>
                
                <div class="story-actions">
                    <button type="button" class="btn-1" onclick="openPopup()">Записаться на консультацию</button>
                    <button type="button" class="btn-whatsapp" onclick="window.open('https://wa.me/79084952424', '_blank')">Задать вопрос в WhatsApp</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid-system">
        <div class="story-right grid-6">
            <div class="story-text">
                ...
                <div class="story-description">
                    <p>Здесь может быть дополнительная информация о лечении, результатах или отзывы пациента.</p>
                    
                    <p>Каждый этап лечения важен для достижения идеального результата.</p>
                </div>
        ...
        <div class="story-left grid-6">
            <div class="story-image">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/circle-face-09.jpg" alt="Дополнительное фото">
            </div>
        </div>
    </div>
