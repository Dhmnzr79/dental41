    ...
    <div class="container">
        <div class="hero-mobile__wrapper">
            <div class="hero-mobile__content">
                <h1 class="hero-mobile__title" itemprop="name">Имплантация нового поколения</h1>
...
<!-- Блок про страхи -->
<section class="fears section" itemscope itemtype="https://schema.org/Article">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-6 fears__left">
                <h2 class="fears__title">Почему важно не откладывать?</h2>
                <h3 class="fears__subtitle">90% пациентов приходят поздно - когда приходится удалять уже и соседние зубы</h3>
                <h3 class="fears__subtitle">Без зуба костная ткань убывает на 30% за первый год</h3>
                <p class="fears__warning" itemprop="description">
                    Откладывая имплантацию, вы теряете не только зуб, но и кость.
                </p>
                
                <div class="fears__consequences" itemscope itemtype="https://schema.org/ItemList">
                    <div class="fears__consequence" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                        <meta itemprop="position" content="1">
                        <div class="fears__consequence-icon" aria-hidden="true">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_fears_1)">
                                    <path d="M10.1333 13.8667L7.26667 11C7.02222 10.7556 6.71111 10.6333 6.33333 10.6333C5.95555 10.6333 5.64444 10.7556 5.4 11C5.15556 11.2444 5.03333 11.5556 5.03333 11.9333C5.03333 12.3111 5.15556 12.6222 5.4 12.8667L9.2 16.6667C9.46666 16.9333 9.77778 17.0667 10.1333 17.0667C10.4889 17.0667 10.8 16.9333 11.0667 16.6667L18.6 9.13333C18.8444 8.88889 18.9667 8.57778 18.9667 8.2C18.9667 7.82222 18.8444 7.51111 18.6 7.26667C18.3556 7.02222 18.0444 6.9 17.6667 6.9C17.2889 6.9 16.9778 7.02222 16.7333 7.26667L10.1333 13.8667ZM2.66667 24C1.93333 24 1.30578 23.7391 0.784 23.2173C0.262222 22.6956 0.000888889 22.0676 0 21.3333V2.66667C0 1.93333 0.261333 1.30578 0.784 0.784C1.30667 0.262222 1.93422 0.000888889 2.66667 0H21.3333C22.0667 0 22.6947 0.261333 23.2173 0.784C23.74 1.30667 24.0009 1.93422 24 2.66667V21.3333C24 22.0667 23.7391 22.6947 23.2173 23.2173C22.6956 23.74 22.0676 24.0009 21.3333 24H2.66667Z" fill="#23BFCF"/>
                                </g>
                                <defs>
                                    <clipPath id="clip0_fears_1">
                                        <rect width="24" height="24" fill="white"/>
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
                        <p itemprop="name">Соседние зубы смещаются — лечение усложняется</p>
                    </div>
                    <div class="fears__consequence" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                        <meta itemprop="position" content="2">
                        <div class="fears__consequence-icon" aria-hidden="true">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_fears_2)">
                                    <path d="M10.1333 13.8667L7.26667 11C7.02222 10.7556 6.71111 10.6333 6.33333 10.6333C5.95555 10.6333 5.64444 10.7556 5.4 11C5.15556 11.2444 5.03333 11.5556 5.03333 11.9333C5.03333 12.3111 5.15556 12.6222 5.4 12.8667L9.2 16.6667C9.46666 16.9333 9.77778 17.0667 10.1333 17.0667C10.4889 17.0667 10.8 16.9333 11.0667 16.6667L18.6 9.13333C18.8444 8.88889 18.9667 8.57778 18.9667 8.2C18.9667 7.82222 18.8444 7.51111 18.6 7.26667C18.3556 7.02222 18.0444 6.9 17.6667 6.9C17.2889 6.9 16.9778 7.02222 16.7333 7.26667L10.1333 13.8667ZM2.66667 24C1.93333 24 1.30578 23.7391 0.784 23.2173C0.262222 22.6956 0.000888889 22.0676 0 21.3333V2.66667C0 1.93333 0.261333 1.30578 0.784 0.784C1.30667 0.262222 1.93422 0.000888889 2.66667 0H21.3333C22.0667 0 22.6947 0.261333 23.2173 0.784C23.74 1.30667 24.0009 1.93422 24 2.66667V21.3333C24 22.0667 23.7391 22.6947 23.2173 23.2173C22.6956 23.74 22.0676 24.0009 21.3333 24H2.66667Z" fill="#23BFCF"/>
                                </g>
                                <defs>
                                    <clipPath id="clip0_fears_2">
                                        <rect width="24" height="24" fill="white"/>
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
                        <p itemprop="name">Лицо "западает" — человек выглядит на несколько лет старше</p>
                    </div>
                </div>
            </div>
            
            <div class="col-sm-12 col-lg-6 fears__right">
                <div class="fears__visual">
                    <div class="fears__visual-left">
                        ...
                        <div class="fears__percentage">
                            ...
                            <div class="fears__percentage-text">Костная пластика добавит +3 месяца и до +30% к цене</div>
                        </div>
                    </div>
...
<section class="cta section" itemscope itemtype="https://schema.org/Service">
    <div class="container">
        <div class="row">
                ...
                <div class="cta__content">
                    ...
                    <div class="cta__benefits" itemscope itemtype="https://schema.org/ItemList">
                        <div class="cta__benefit" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            <meta itemprop="position" content="1">
                            <div class="cta__benefit-icon" aria-hidden="true">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_cta_1)">
                                        <path d="M10.1333 13.8667L7.26667 11C7.02222 10.7556 6.71111 10.6333 6.33333 10.6333C5.95555 10.6333 5.64444 10.7556 5.4 11C5.15556 11.2444 5.03333 11.5556 5.03333 11.9333C5.03333 12.3111 5.15556 12.6222 5.4 12.8667L9.2 16.6667C9.46666 16.9333 9.77778 17.0667 10.1333 17.0667C10.4889 17.0667 10.8 16.9333 11.0667 16.6667L18.6 9.13333C18.8444 8.88889 18.9667 8.57778 18.9667 8.2C18.9667 7.82222 18.8444 7.51111 18.6 7.26667C18.3556 7.02222 18.0444 6.9 17.6667 6.9C17.2889 6.9 16.9778 7.02222 16.7333 7.26667L10.1333 13.8667ZM2.66667 24C1.93333 24 1.30578 23.7391 0.784 23.2173C0.262222 22.6956 0.000888889 22.0676 0 21.3333V2.66667C0 1.93333 0.261333 1.30578 0.784 0.784C1.30667 0.262222 1.93422 0.000888889 2.66667 0H21.3333C22.0667 0 22.6947 0.261333 23.2173 0.784C23.74 1.30667 24.0009 1.93422 24 2.66667V21.3333C24 22.0667 23.7391 22.6947 23.2173 23.2173C22.6956 23.74 22.0676 24.0009 21.3333 24H2.66667Z" fill="white"/>
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_cta_1">
                                            <rect width="24" height="24" fill="white"/>
                                        </clipPath>
                                    </defs>
                                </svg>
                        ...
                        <div class="cta__benefit" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            ...
                            <div class="cta__benefit-icon" aria-hidden="true">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_cta_2)">
                                        <path d="M10.1333 13.8667L7.26667 11C7.02222 10.7556 6.71111 10.6333 6.33333 10.6333C5.95555 10.6333 5.64444 10.7556 5.4 11C5.15556 11.2444 5.03333 11.5556 5.03333 11.9333C5.03333 12.3111 5.15556 12.6222 5.4 12.8667L9.2 16.6667C9.46666 16.9333 9.77778 17.0667 10.1333 17.0667C10.4889 17.0667 10.8 16.9333 11.0667 16.6667L18.6 9.13333C18.8444 8.88889 18.9667 8.57778 18.9667 8.2C18.9667 7.82222 18.8444 7.51111 18.6 7.26667C18.3556 7.02222 18.0444 6.9 17.6667 6.9C17.2889 6.9 16.9778 7.02222 16.7333 7.26667L10.1333 13.8667ZM2.66667 24C1.93333 24 1.30578 23.7391 0.784 23.2173C0.262222 22.6956 0.000888889 22.0676 0 21.3333V2.66667C0 1.93333 0.261333 1.30578 0.784 0.784C1.30667 0.262222 1.93422 0.000888889 2.66667 0H21.3333C22.0667 0 22.6947 0.261333 23.2173 0.784C23.74 1.30667 24.0009 1.93422 24 2.66667V21.3333C24 22.0667 23.7391 22.6947 23.2173 23.2173C22.6956 23.74 22.0676 24.0009 21.3333 24H2.66667Z" fill="white"/>
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_cta_2">
                                            <rect width="24" height="24" fill="white"/>
                                        </clipPath>
                                    </defs>
                                </svg>
                        ...
                        <div class="cta__benefit" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                            ...
                            <div class="cta__benefit-icon" aria-hidden="true">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_cta_3)">
                                        <path d="M10.1333 13.8667L7.26667 11C7.02222 10.7556 6.71111 10.6333 6.33333 10.6333C5.95555 10.6333 5.64444 10.7556 5.4 11C5.15556 11.2444 5.03333 11.5556 5.03333 11.9333C5.03333 12.3111 5.15556 12.6222 5.4 12.8667L9.2 16.6667C9.46666 16.9333 9.77778 17.0667 10.1333 17.0667C10.4889 17.0667 10.8 16.9333 11.0667 16.6667L18.6 9.13333C18.8444 8.88889 18.9667 8.57778 18.9667 8.2C18.9667 7.82222 18.8444 7.51111 18.6 7.26667C18.3556 7.02222 18.0444 6.9 17.6667 6.9C17.2889 6.9 16.9778 7.02222 16.7333 7.26667L10.1333 13.8667ZM2.66667 24C1.93333 24 1.30578 23.7391 0.784 23.2173C0.262222 22.6956 0.000888889 22.0676 0 21.3333V2.66667C0 1.93333 0.261333 1.30578 0.784 0.784C1.30667 0.262222 1.93422 0.000888889 2.66667 0H21.3333C22.0667 0 22.6947 0.261333 23.2173 0.784C23.74 1.30667 24.0009 1.93422 24 2.66667V21.3333C24 22.0667 23.7391 22.6947 23.2173 23.2173C22.6956 23.74 22.0676 24.0009 21.3333 24H2.66667Z" fill="white"/>
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_cta_3">
                                            <rect width="24" height="24" fill="white"/>
                                        </clipPath>
                                    </defs>
                                </svg>
            ...
            <div class="col-sm-12 col-lg-4 cta__right">
                <div class="cta__form-wrapper">
                    <h3 class="cta__form-title">Оставьте заявку сейчас</h3>
                    <p class="cta__form-description">И мы разберём, как сохранить кость и сэкономить до 30% на лечении — пока не стало поздно</p>
                    
                    <div class="cta__form">
                        <?php
                        // Contact Form 7 форма
                        echo do_shortcode('[contact-form-7 id="620f6b6" title="Заявка молодость"]');
                        ?>
...
<section class="section faq" itemscope itemtype="https://schema.org/FAQPage">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-4 faq__title-col">
                <h2 class="faq__title">Ответы на самые важные вопросы об имплантации</h2>
                <p class="faq__subtitle">Мы собрали честные и понятные ответы врачей ЦЭСИ, чтобы развеять страхи и помочь вам чувствовать себя спокойнее перед лечением.</p>
            </div>
            
            <div class="col-sm-12 col-lg-8 faq__content-col">
                <div class="faq__accordion">
                    <article class="faq__item faq__item--active" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <button class="faq__question" type="button" aria-expanded="true" aria-controls="faq-answer-1">
                            <span itemprop="name">Имплантация — это очень больно?</span>
                        </button>
                        <div class="faq__answer" id="faq-answer-1" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                            <div itemprop="text">
                    ...
                    <article class="faq__item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <button class="faq__question" type="button" aria-expanded="false" aria-controls="faq-answer-2">
                            <span itemprop="name">Будет ли много осложнений после имплантации?</span>
                        </button>
                        <div class="faq__answer" id="faq-answer-2" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                            <div itemprop="text">
                    ...
                    <article class="faq__item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <button class="faq__question" type="button" aria-expanded="false" aria-controls="faq-answer-3">
                            <span itemprop="name">А если имплант не приживётся?</span>
                        </button>
                        <div class="faq__answer" id="faq-answer-3" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                            <div itemprop="text">
                    ...
                    <article class="faq__item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <button class="faq__question" type="button" aria-expanded="false" aria-controls="faq-answer-4">
                            <span itemprop="name">Не все врачи умеют грамотно ставить импланты?</span>
                        </button>
                        <div class="faq__answer" id="faq-answer-4" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                            <div itemprop="text">
                    ...
                    <article class="faq__item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <button class="faq__question" type="button" aria-expanded="false" aria-controls="faq-answer-5">
                            <span itemprop="name">Имплантация — это очень дорого?</span>
                        </button>
                        <div class="faq__answer" id="faq-answer-5" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                            <div itemprop="text">
                    ...
                    <article class="faq__item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <button class="faq__question" type="button" aria-expanded="false" aria-controls="faq-answer-6">
                            <span itemprop="name">После имплантации будет «дырка» между зубами?</span>
                        </button>
                        <div class="faq__answer" id="faq-answer-6" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                            <div itemprop="text">
                    ...
                    <article class="faq__item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <button class="faq__question" type="button" aria-expanded="false" aria-controls="faq-answer-7">
                            <span itemprop="name">Установка импланта занимает очень много времени?</span>
                        </button>
                        <div class="faq__answer" id="faq-answer-7" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                            <div itemprop="text">
